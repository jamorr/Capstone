...
def explode_wind(df):
    ...
    wind_exp.drop(['speed_quality', 'direction_quality', 'observation_type'], axis=1, inplace=True)
...
def weather_parse(weather_dir=pathlib.Path("../data/weather"), start_date=None, end_date=None):
